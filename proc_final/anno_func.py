...
def load_mask(annos, datadir, imgid, imgdata):
    ...
    [
	{'category': 'wo', 
	'bbox': {'xmin': 1265.08, 'ymin': 1405.56, 'ymax': 1426.1905, 'xmax': 1285.7178999999999}, 
	'polygon': [[1276.36, 1405.55], [1265.74, 1425.09], [1281.06, 1423.88], [1285.34, 1422.2]]形状信息
	},
	{'category': 'po',
	'bbox': {'xmin': 1234.92, 'ymin': 1402.38, 'ymax': 1426.1941000000002, 'xmax': 1257.1429},
	'ellipse_org': [[1252.75, 1408.86], [1235.69, 1413.74], [1240.21, 1424.88], [1245.23, 1428.5], [1254.28, 1423.07], [1242.23, 1404.89]],
	'ellipse': [[1245.2862548828125, 1415.6944580078125], [19.28538703918457, 24.858810424804688], 158.2991485595703]
	}
 ]
 mask_ellipse为填充面积的图片
    '''
    img = annos["imgs"][imgid]
...
#     不懂啥意思
    ...
    return mask,mask_ellipse,img
#标注信息     
def draw_all(annos, datadir, imgid, imgdata, color=(0,1,0), have_mask=True, have_label=True):
    img = annos["imgs"][imgid]
    if have_mask:
#         print('应该打印')
        mask,mask_ellipse,img = load_mask(annos, datadir, imgid, imgdata)
    ...
    return imgdata,mask_ellipse,img
